...
export class UserService {
    private readonly userSubject$: BehaviorSubject<UserRole | null> = new BehaviorSubject<UserRole | null>(null); // Оно хранит текущее состояние пользователя (IUser или null). Изначально значение null.

    public readonly user$: Observable<UserRole | null> = this.userSubject$.asObservable();
