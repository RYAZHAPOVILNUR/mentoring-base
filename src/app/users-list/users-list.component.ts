...
const result8 = data.filter(data => data.website.includes('.com')).map(data => data.website);

console.log({result8});

// 9 задача 

const result9 = data.filter(data => data.username.length > 12).map(data => data.username);
