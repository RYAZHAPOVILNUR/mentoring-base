...
console.log('reversed:', answer6);

const answer7__test = data.length;

console.log('it works and answer is: ' + answer7__test);

const answer8 = data.reduce((acc, curr) => [...acc, curr.website.includes('.com') ? curr : null],[]).filter(el => Boolean(el))
...
const answer10 = data.map(el => el.username.toLowerCase());
