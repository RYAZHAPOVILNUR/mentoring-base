...
const task1 = data.map(el => ({id: el.id, username: el.username}))
console.log({task1})
...
const task2 = data.reduce((acc, curr) => [...acc, curr.email], [])
console.log({task2})
...
const task3 = data.find( el => el.id === 9)
console.log({task3})
...
const task4 = data.filter(el => el.address.city === 'Lebsackbury');
console.log({task4})
...
const task8 = data.reduce((acc, curr) => 
[...acc, curr.website.includes('.com') ? curr : null] , []).filter(el => Boolean(el))
console.log({task8})
